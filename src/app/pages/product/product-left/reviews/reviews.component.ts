...
export class ReviewsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    arrayReview.forEach((value, index, arr) => {
      ...
      // Comparamos si tanto el primer índice como el último índice
      // del mismo valor son diferentes, Si es diferente significa que se repite varias veces, si son iguales significa que nunca se repite
    ...
    for (let i = 5; i > 0; i--) {
      ...
      const starPercentage = Math.round(
        (objectStar[i] * 100) / arrayReview.length
      );
